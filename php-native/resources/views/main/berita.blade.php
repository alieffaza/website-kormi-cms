    ...
    <div class="row g-4">
        ...
        <div class="col-12 col-md-4">
            <div class="card h-100 shadow-sm">
                @if($berita->gambar)
                <img src="{{ asset('storage/' . $berita->gambar) }}" class="card-img-top w-100" alt="Cover Berita: {{ $berita->judul }}" style="object-fit:cover; max-height:180px; border-radius:0.5rem 0.5rem 0 0;">
                @endif
                <div class="card-body">
